...
func init() {
	...
	// usagelogDescBillingChargeMultiplier is the schema descriptor for billing_charge_multiplier field.
	usagelogDescBillingChargeMultiplier := usagelogFields[28].Descriptor()
	// usagelog.DefaultBillingChargeMultiplier holds the default value on creation for the billing_charge_multiplier field.
	usagelog.DefaultBillingChargeMultiplier = usagelogDescBillingChargeMultiplier.Default.(float64)
