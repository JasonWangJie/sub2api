...
func registerRoutes(
	...
	routes.RegisterPaymentRoutes(v1, h.Payment, h.PaymentWebhook, h.Admin.Payment, h.Invoice, h.Admin.Invoice, jwtAuth, adminAuth, auditLog, settingService, panelRateLimiter)
