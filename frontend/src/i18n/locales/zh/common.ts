export default {
  ...
  invoice: {
    description: '选择符合条件的充值记录，提交企业增值税发票申请。',
    adminDescription: '查看并处理用户企业开票申请。',
    records: '可开票充值记录',
    applications: '申请记录',
    profile: '开票信息',
    email: '邮箱号',
    ...
    selectable: '可开票',
    excluded: '不可开票',
    excludedGrant: '赠款不计入开票范围',
    excludedAffiliate: '返利不计入开票范围',
    applied: '已申请',
    totalSelected: '已勾选合计',
    minimumHint: '开票金额需达到 1,000.00',
    submit: '提交开票申请',
    confirmTitle: '确认开票信息',
    confirmMessage: '请确认以下企业信息准确无误。提交后不可修改，所选订单也将锁定。',
    confirmSubmit: '确认无误并提交',
    noRecords: '暂无充值记录',
    profileSaved: '已自动带入上次填写的信息',
    applicationNo: '申请编号',
    pending: '申请中',
    completed: '已完成',
    rejected: '已拒绝',
    ...
    reject: '拒绝申请',
    rejectReason: '拒绝原因',
    confirmComplete: '确认已完成开票？确认后申请状态将不可逆变更。',
    confirmReject: '请输入拒绝原因',
    sourcePayment: '在线充值',
    sourceRedeem: '余额卡充值',
    sourceGrant: '管理员赠款',
    sourceAffiliate: '返利转入',
    adminViews: '企业开票管理视图',
    historicalRecords: '历史开票补录',
    historicalDescription: '选择上线前已线下开票的用户充值记录并永久标记。此操作不可撤销。',
    historicalSearch: '搜索邮箱、用户名或订单编号',
    sourceReference: '订单编号',
    user: '用户',
    userId: '用户 ID',
    markedAt: '操作时间',
    markedBy: '操作管理员',
    available: '可补录',
    historicalCompleted: '已开票（历史补录）',
    selectedCount: '已选 {count} 条',
    historicalMark: '标记已开票',
    historicalMarkTitle: '确认历史开票补录',
    historicalMarkMessage: '这是上线前线下开票记录的历史补录。提交后操作不可撤销，所选订单将永久不能再次申请或补录发票。请确认所选记录准确。',
    historicalMarkConfirm: '确认标记且不可撤销',
    errors: {
      load: '加载开票数据失败',
      submit: '提交开票申请失败',
      minimum: '所选金额不足 1,000.00',
      historicalMark: '历史开票补录失败',
    }
  },
