export default {
  ...
  payment: {
    ...
    actualPay: '实付金额',
    createOrder: '确认支付',
    usdtRechargeTitle: 'USDT 余额充值',
    usdtRechargeHint: '按 Epusdt 配置的 CNY 或 USDT 计价，选择网络后跳转至托管收银台完成付款。',
    usdtUnavailable: 'USDT 充值暂不可用，请联系管理员。',
    usdtAmountLabel: '充值金额',
    usdtAmountHint: '单笔金额范围：{range}',
    usdtNetworkLabel: 'USDT 网络',
    usdtPaymentAmount: '支付金额',
    usdtExchangeRate: '实时汇率',
    usdtConvertedAmount: '实时折算',
    usdtBonus: '充值赠送',
    usdtExpectedCNY: '预计增加余额（含赠送）',
    usdtExpectedBalance: '预计入账余额（USD）',
    usdtRateStale: '使用缓存汇率',
    usdtNetworkWarning: '必须使用与所选项目完全一致的链上网络；交易所内部转账无法识别。',
    usdtCreateOrder: '前往 Epusdt 收银台',
    usdtCreateFailed: 'USDT 订单创建失败，请稍后重试。',
    methods: {
      easypay: '易支付',
      alipay: '支付宝',
      wxpay: '微信支付',
    ...
    orders: {
      ...
      payAmount: '实付',
      creditedAmount: '到账金额',
      usdtRechargeAmount: '充值的 U',
      usdtBonusAmount: '赠款',
      usdtCreditedCNY: '到账 CNY',
      fee: '手续费',
      baseAmount: '充值金额',
