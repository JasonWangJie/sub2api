export default {
  ...
  payment: {
    ...
    usdtRechargeTitle: 'USDT Balance Recharge',
    usdtRechargeHint: 'Amounts use the Epusdt CNY or USDT pricing mode. Choose a network, then complete payment in the hosted cashier.',
    usdtUnavailable: 'USDT recharge is currently unavailable. Please contact an administrator.',
    usdtAmountLabel: 'Recharge amount',
    usdtAmountHint: 'Single-order range: {range}',
    usdtNetworkLabel: 'USDT network',
    usdtPaymentAmount: 'Payment amount',
    usdtExchangeRate: 'Live rate',
    usdtConvertedAmount: 'CNY equivalent',
    usdtBonus: 'Recharge bonus',
    usdtExpectedCNY: 'Expected balance increase (with bonus)',
    usdtExpectedBalance: 'Expected credited balance (USD)',
    usdtRateStale: 'cached rate',
    usdtNetworkWarning: 'You must use the exact same on-chain network as selected; exchange internal transfers cannot be identified.',
    usdtCreateOrder: 'Open Epusdt cashier',
    usdtCreateFailed: 'Unable to create the USDT order. Please try again later.',
    methods: {
      easypay: 'EasyPay',
      alipay: 'Alipay',
      wxpay: 'WeChat Pay',
    ...
    orders: {
      ...
      usdtRechargeAmount: 'USDT recharge',
      usdtBonusAmount: 'Bonus',
      usdtCreditedCNY: 'Credited CNY',
      fee: 'Fee',
