export default {
    settings: {
      ...
      payment: {
        ...
        field_epusdtApiBaseHint: 'Public Epusdt base URL, for example https://pay.example.com. The callback must use public HTTPS.',
        field_epusdtCurrencyHint: 'Choose USDT or CNY. New Epusdt instances default to USDT; legacy instances without a currency remain compatible as CNY.',
        field_epusdtBonusRateHint: 'Recharge bonus percentage for USDT/CNY, from 0 to 100 with at most two decimals.',
        field_epusdtNetworksHint: 'Comma-separated network codes. Use code=display alias, for example tron=TRC20,ethereum=ERC20,bsc; plain codes remain supported.',
