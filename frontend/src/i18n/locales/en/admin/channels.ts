export default {
    ...
    channelMonitor: {
      ...
      reset: 'Reset',
      resetting: 'Resetting',
      resetSuccess: 'Monitor data reset',
      resetFailed: 'Failed to reset monitor data',
      resetConfirm: 'Clear all history and statistics for monitor "{name}"? Its configuration and API key will be kept. If enabled, future checks will create new data.',
