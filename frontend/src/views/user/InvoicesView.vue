      ...
      <section class="card overflow-hidden">
        ...
        <div class="overflow-x-auto">
          <table class="w-full min-w-[640px] divide-y divide-gray-200 dark:divide-dark-700">
            ...
            <tbody class="divide-y divide-gray-200 bg-white dark:divide-dark-700 dark:bg-dark-900">
              <tr v-if="applicationsLoading"><td colspan="4" class="px-4 py-8 text-center text-sm text-gray-500">{{ t('common.loading') }}</td></tr>
              <tr v-else-if="applications.length === 0"><td colspan="4" class="px-4 py-8 text-center text-sm text-gray-500">{{ t('invoice.noRecords') }}</td></tr>
